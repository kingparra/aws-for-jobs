...
# createPubPrivSubnets :: SeedTagValue
#                      -> VpcId
#                      -> IO ([SubnetId],[CreateSubnet Subnet])
...
getPubPrivSubnets() {
  yt ec2 describe-subnets \
      --filters "Name='tag:Name',Values=['public-subnet-1','public-subnet-2','private-subnet-1','private-subnet-2']" \
...
###############################
createIGW() {
  yt ec2 create-internet-gateway \
    --tag-specifications \
...
getMyIgw() {
yt ec2 describe-internet-gateways \
